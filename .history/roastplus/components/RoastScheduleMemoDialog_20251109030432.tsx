              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <label className={`flex flex-col items-center justify-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                  ...
                  <input
                    ...
                    className="sr-only"
                  />
                  <PiCoffeeBeanDuotone className={`text-2xl ${isRoast ? 'text-amber-700' : 'text-gray-400'}`} />
                ...
                <label className={`flex flex-col items-center justify-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                  ...
                  <input
                    ...
                    className="sr-only"
                  />
                  <FaBroom className={`text-2xl ${isChaffCleaning ? 'text-amber-800' : 'text-gray-400'}`} />
                  <span className={`text-sm font-medium ${isChaffCleaning ? 'text-amber-800' : 'text-gray-700'}`}>
                    チャフのお掃除
                  </span>
                </label>
              </div>
            ...
            {(isRoasterOn || isRoast || isAfterPurge || isChaffCleaning) && (
              <div className={`rounded-md border-2 p-3 ${getPreviewColor()} flex justify-center`}>
                <div className="flex items-center gap-2">
                  ...
                  {isRoast && <PiCoffeeBeanDuotone className="text-lg text-amber-700" />}
